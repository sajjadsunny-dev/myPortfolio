      ...
      <>
         <section className="">
            ...
            <div className="h-screen bg-transparent flex flex-col items-center justify-center ml-[300px]">
               ...
               <button className="px-40 py-[15px] mt-8 rounded-customRadius border-[1px] border-solid border-themeColor font-poppins text-base text-themeColor font-medium duration-500 hover:bg-themeColor hover:text-white">Hire Me</button>
            </div>
         </section>
      </>
   )
